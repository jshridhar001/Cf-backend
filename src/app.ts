...
import { fieldInstructionRoutes } from "./features/field-instructions/field-instructions.routes.js";
import { fieldTasksRoutes } from "./features/field-tasks/field-tasks.routes.js";
...
export const buildApp = async (): Promise<FastifyInstance> => {
  ...
  await fastify.register(fieldTasksRoutes, { prefix: "/api/v1/field-tasks" });
  await fastify.register(fieldInstructionRoutes, { prefix: "/api/v1/field-instructions" });
