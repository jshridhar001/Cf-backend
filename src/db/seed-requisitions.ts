...
export async function seedRequisitions() {
  ...
  const rows = [
    ...
    },
    {
      ...
      approvedDeliveryDate: new Date("2026-08-28T00:00:00.000Z"),
    ...
    },
    {
      ...
      approvedDeliveryDate: new Date("2026-08-25T00:00:00.000Z"),
    ...
    },
    {
      ...
      approvedDeliveryDate: new Date("2026-09-01T00:00:00.000Z"),
